...
echo $parameter['jstemplate'] ? $parameter['jstemplate'] : '<li>{tname}</li>';
echo '</textarea>' . "\r\n" . '    </td>' . "\r\n" . '    </tr>' . "\r\n" . '    </tbody>' . "\r\n" . '</table>' . "\r\n" . '</div>' . "\r\n" . '<div id="';
echo MPS_SOFTNAME;
echo '">' . "\r\n" . '<table border="0" cellspacing="0" cellpadding="0" class="vbm">' . "\r\n" . '<tr class="firstr"><td colspan="2">主题列表</td></tr>' . "\r\n" . '<tbody id="menu_4d4985d65fe805ed" style="display: yes; background-color:white">' . "\r\n" . '<tr><td width="45%" class="altbg1" ><b>标签名/商家调用唯一标识:</b><br /><span class="smalltxt">请输入一个便于记忆的能代表此商家调用脚本作用的标识，建议用英文及数字表示</span></td><td class="altbg2"><input type="text" class="text" size="50" name="flag" value="';
echo $flag;
...
echo cat_list('corp', '', $parameter[catid], true);
...
echo cat_list('area', 0, $parameter['areaid']);
echo '</select>' . "\r\n" . '</td>' . "\r\n" . '</tr>' . "\r\n" . '<tr>' . "\r\n" . '<td width="45%" class="altbg1" ><b>所在会员组:</b></td>' . "\r\n" . '<td class="altbg2">' . "\r\n";
echo get_member_level($parameter[levelid], 'parameter[levelid]');
echo '</td>' . "\r\n" . '</tr>' . "\r\n" . '<tr><td width="45%" class="altbg1" ><b>显示商家条数:</b><br /><span class="smalltxt">设置一次显示的商家条数，请设置为大于 0 的整数</span></td><td class="altbg2"><input type="text" class="text" size="50" name="parameter[items]" value="';
...
echo '> 在新窗口打开</label></td></tr><tr><td width="45%" class="altbg1" ><b>商家排序方式:</b><br /><span class="smalltxt">设置以哪一字段对主题进行排序</span></td><td class="altbg2"><label for="dateline"><input class="radio" type="radio" name="parameter[orderby]" value="dateline" id="dateline" ';
if (($parameter[orderby] == 'dateline') || !$parameter) {
	echo 'checked';
}

echo '> 按注册时间倒序排序</label><br /><label for="views"><input class="radio" type="radio" name="parameter[orderby]" value="views" id="views" ';

if ($parameter[orderby] == 'level') {
	echo 'checked';
}

echo '> 按会员组级别</label></td></tr>' . "\r\n" . '<tr><td width="45%" class="altbg1" ><b>强制字符转换:</b><br /><span class="smalltxt">强制转换数据调用输出的文字为 UTF-8 编码</span></td><td class="altbg2"><label for="jacharset"><input class="radio" type="radio" name="parameter[jscharset]" value="1" ';
