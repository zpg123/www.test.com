...
echo cat_list('category', 0, $parameter[catid], true);
...
echo '</select>' . "\r\n" . '</td>' . "\r\n" . '</tr>' . "\r\n" . '<tr><td width="45%" class="altbg1" ><b>显示数据条数:</b><br /><span class="smalltxt">设置一次显示的主题条目数，请设置为大于 0 的整数</span></td><td class="altbg2"><input type="text" class="text" size="50" name="parameter[items]" value="';
...
echo '" >' . "\r\n" . '</td></tr><tr><td width="45%" class="altbg1" ><b>指定主题:</b><br />' . "\r\n" . '<span class="smalltxt">设置要指定显示的主题 id ，多个 id 请用半角逗号“,”隔开。注意: 留空为不进行任何过滤</span></td><td class="altbg2"><input type="text" class="text" size="50" name="parameter[ids]" value="';
echo $parameter[ids];
echo '" >' . "\r\n" . '</td></tr><tr><td width="45%" class="altbg1" ><b>标题关键字:</b><br /><span class="smalltxt">设置标题包含的关键字。注意: 留空为不进行任何过滤<br />关键字中可使用通配符 "*"<br />匹配多个关键字全部，可用空格或 "AND" 连接。如 win32 AND unix<br />匹配多个关键字其中部分，可用 "|" 或 "OR" 连接。如 win32 OR unix</span></td><td class="altbg2"><input type="text" class="text" size="50" name="parameter[keyword]" value="';
echo $parameter[keyword];
...
echo '> 在新窗口打开</label></td></tr><tr><td width="45%" class="altbg1" ><b>主题排序方式:</b><br /><span class="smalltxt">设置以哪一字段对主题进行排序</span></td><td class="altbg2"><label for="dateline"><input class="radio" type="radio" name="parameter[orderby]" value="dateline" id="dateline" ';
