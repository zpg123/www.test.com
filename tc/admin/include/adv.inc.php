...
$vbm_adv_type[topbanner][notice] = '<li><strong>展现方式：</strong> 顶部横幅广告位于网站顶部，通常使用 980*60 图片或 Flash 的形式。' . "\r\n" . '</li><li><strong>价值分析：</strong> 由于能够在页面打开的第一时间将广告内容展现于最醒目的位置，因此成为了网页中价位最高、最适合进行商业宣传或品牌推广的广告类型之一。</li>';
$vbm_adv_type[headerbanner][name] = '[系统] 页头通栏广告';
$vbm_adv_type[headerbanner][notice] = '<li><strong>展现方式：</strong> 页头通栏广告显示于导航栏下方，可使用7张140*70 图片或 Flash 的形式也可使用1张 1000*60的横幅图片或flash。' . "\r\n" . '</li><li><strong>价值分析：</strong> 由于能够在页面打开的第一时间将广告内容展现于最醒目的位置，因此成为了网页中价位最高、最适合进行商业宣传或品牌推广的广告类型之一。</li>';
$vbm_adv_type[footerbanner][name] = '[系统] 页尾通栏广告';
$vbm_adv_type[footerbanner][notice] = '<li><strong>展现方式：</strong>  页尾通栏广告显示于网站页面中下方，通常使用 960x60 或其它尺寸图片、Flash 的形式。' . "\r\n" . '</li><li><strong>价值分析：</strong> 与页面头部和中部相比，页面尾部的展现机率相对较低，通常不会引起访问者的反感，同时又基本能够覆盖所有对广告内容感兴趣的受众，因此适合中性而温和的推广。</li>';
...
$vbm_adv_type[indexcatad][notice] = '<li><strong>展现方式：</strong> 分类间广告显示于网站首页相邻的两个根分类之间，可使用 1000*60 或其它尺寸图片和 Flash 的形式。' . "\r\n" . '</li><li><strong>价值分析：</strong>由于出现在网站首页比较明显的位置，广告展示效果较好，但是过多过大的首页广告可能会招致访问者反感。</li>';
$vbm_adv_type[infoad][name] = '[系统] 信息阅读页详情内广告';
$vbm_adv_type[infoad][notice] = '<li><strong>展现方式：</strong> 信息阅读页详情内广告显示于信息内容介绍的正下方。' . "\r\n" . '</li><li><strong>价值分析：</strong> 嵌入信息内容内部的广告，可在用户浏览信息内容时自然的被接受，适合于特定内容的有效推广，也可用于网站自身的宣传和公告之用。</li>';
$vbm_adv_style = array();
