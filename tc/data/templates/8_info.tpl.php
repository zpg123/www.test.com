...
<span class="attrVal"  style="<? if(strexists($mymps['value'],'元')) { ?>color:#ff7800;font-weight:bold;font-size:20px;<?php } ?>"><? if(in_array($mymps['value'],array('0元','0元/月','0元/平米/天','0万元','0.00元','0.00万元'))) { ?>面议<?php } else { ?><?=$mymps['value']?><?php } ?></span>
</li>
            <?php } ?>
<?php }} ?>
</ul>
