...
<div class="cinner">
<div class="leftnav">
        <?php if(is_array($aboutus_all)){foreach($aboutus_all as $mymps) { ?><a href="<?=$mymps_global['SiteUrl']?><?=$mymps['uri']?>" <? if($mymps['id'] == $aboutus['id']) { ?>class="current"<?php } ?>><?=$mymps['typename']?></a>
            <?php }} ?>
</div>
