...
<link type="text/css" rel="stylesheet" href="template/css/member_new.css">
    <script>window['current'] = '更换头像';</script>
    <script>
    function chkSubmit(){
...
<div class="register-form">
    <form name="Form1" onSubmit="return chkSubmit();" method="post" action="index.php?mod=member&action=upface&dopost=1" style="margin:0" enctype="multipart/form-data">
        ...
        <input name="normalface" value="<?=$row['prelogo']?>" type="hidden">
        <p class="box"><span class="form_label">当前头像：</span><span class="form_control"><img src="<? echo $row['prelogo'] ? $row['prelogo'] : 'template/images/center_ico.png'; ?>" id="Image1"  width="110" height="110" /></span></p>
