...
<div class="sitemap">
<div class="ul">
        <?php if(is_array($categories)){foreach($categories as $mymps) { ?>            <div class="h3"><a target="_blank" href='<?=$mymps['uri']?>'><?=$mymps_global['SiteCity']?><?=$mymps['catname']?></a></div>
<div class="clearfix"></div>
            <ul>
            <?php if(is_array($mymps['children'])){foreach($mymps['children'] as $w) { ?>            <li><a target="_blank" href='<?=$w['uri']?>' title="<?=$mymps_global['SiteCity']?><?=$w['catname']?>"><?=$mymps_global['SiteCity']?><? echo cutstr($w['catname'],15); ?></a> </li>
            <?php }} ?>
            </ul>
            <?php }} ?>
         </div>
