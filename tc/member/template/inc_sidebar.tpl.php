        ...
        <div class="sidebarmenu">
            <div class="sidebarmenu-inner">
                <div class="sidebarmenu-list">
                    <ul class="faceview">
                    	<div class="img"><img src="<?php echo $face != '' ? $face : '/images/noavatar_small.gif'?>" alt="" width="66" height="66" /></div>
                    </ul>
					<?php if($type == 'user'){?>
                    <ul class="index">
					<li <?php if($m != 'index'){?>onmouseover= "this.className= 'li_mouseover '; " onmouseout= "this.className= 'li_normal '; " <?php } if($m == 'index') echo 'class="current"'; ?>><a href="?type=user" class="house">首页</a></li>
                    </ul>
					<?php }?>
                        <?php 
