                            ...
                            <div class="pwrap setting-userinfo">
                                ...
                                <div class="pbody">
                                    <div class="cleafix pagetab-wrap">
                                        <ul class="pagetab">
                                            <li><a href="?m=shop&type=corp&ac=base" <?php if($ac == 'base'){?>class="current"<?php }?>><span><?php echo $if_corp != 1 ? '申请开通网上店铺' : '基本信息修改'; ?></span></a></li>
                                            <li><a href="?m=shop&type=corp&ac=template" <?php if($ac == 'template'){?>class="current"<?php }?>><span>店铺模板修改</span></a></li>
                                        </ul>
                                    </div>
...
<?php }else{?>尚未上传<?php }?> 
										...
										<div class="form-enter">
											 ...
											 图片尺寸<?php echo $mymps_mymps['cfg_banner_limit']['width'];?>×<?php echo $mymps_mymps['cfg_banner_limit']['height'];?>, 
