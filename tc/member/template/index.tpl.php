                        ...
                        <div class="content-main-inner">
                            ...
                            <ul class="clearfix statistics-list">
								<div class="clearfix counttable">
									<div class="cli"><span class="label">分类信息</span> <span class="value"><a href="index.php?m=info"><?=$info_total?>条</a></span> <input name="postinfo" value="发布信息&raquo;" type="button" class="postinfo" onClick="window.open('<?php echo (!$row['tel'] && !$row['qq']) ? '?m=base&error=41' : '../'.$mymps_global['cfg_postfile']; ?>')"></div>
