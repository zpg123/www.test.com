    ...
    <div class="pbody">
        ...
        <div class="albumlist">
            <ul>
                ...
                <li class="li">
                <a href="<?php echo $mymps_global[SiteUrl].$album['path'];?>" target="_blank" class="box" title="点击查看实际图片"><img src="<?php echo $mymps_global[SiteUrl].$album['prepath']?>" border="0" style="max-height:120px"></a>
